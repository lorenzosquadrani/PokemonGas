...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, TRAINER_ISABEL_2, TRAINER_ISABEL_3, TRAINER_ISABEL_4, TRAINER_ISABEL_5, EMILIA_ROAD),
    ...
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_2, TRAINER_ABIGAIL_3, TRAINER_ABIGAIL_4, TRAINER_ABIGAIL_5, EMILIA_ROAD),
    ...
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN_1, TRAINER_BENJAMIN_2, TRAINER_BENJAMIN_3, TRAINER_BENJAMIN_4, TRAINER_BENJAMIN_5, EMILIA_ROAD),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_EDWIN_2, TRAINER_EDWIN_3, TRAINER_EDWIN_4, TRAINER_EDWIN_5, EMILIA_ROAD),
    ...
    [REMATCH_FLANNERY] = REMATCH(TRAINER_FLANNERY_1, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, SANTA_GIUSTINA),
    ...
    [REMATCH_UGUCCIONI] = REMATCH(TRAINER_UGUCCIONI, TRAINER_UGUCCIONI, TRAINER_UGUCCIONI, TRAINER_UGUCCIONI, TRAINER_UGUCCIONI, DIFA),
    [REMATCH_FRABONI] = REMATCH(TRAINER_FRABONI, TRAINER_FRABONI, TRAINER_FRABONI, TRAINER_FRABONI, TRAINER_FRABONI, DIFA),
    [REMATCH_CASTELLANI] = REMATCH(TRAINER_CASTELLANI, TRAINER_CASTELLANI, TRAINER_CASTELLANI, TRAINER_CASTELLANI, TRAINER_CASTELLANI, DIFA),
    [REMATCH_KAMENCIK] = REMATCH(TRAINER_KAMENCIK, TRAINER_KAMENCIK, TRAINER_KAMENCIK, TRAINER_KAMENCIK, TRAINER_KAMENCIK, DIFA),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, DIFA),
};
...
static u8 GetTrainerBattleTransition(void)
{
    ...
    {
        if (gTrainerBattleOpponent_A == TRAINER_UGUCCIONI)
            return B_TRANSITION_UGUCCIONI;
        if (gTrainerBattleOpponent_A == TRAINER_FRABONI)
            return B_TRANSITION_FRABONI;
        if (gTrainerBattleOpponent_A == TRAINER_CASTELLANI)
            return B_TRANSITION_CASTELLANI;
        if (gTrainerBattleOpponent_A == TRAINER_KAMENCIK)
            return B_TRANSITION_KAMENCIK;
        return B_TRANSITION_CHAMPION;
    }
