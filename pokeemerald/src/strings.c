...
const u8 gText_DefaultNameStu[] = _("GAS");
...
const u8 gText_InBagVar1[] = _("NELLA BORSA: {STR_VAR_1}");
...
const u8 gText_AnythingElseICanHelp[] = _("Ti serve qualcos'altro??");
const u8 gText_CanIHelpWithAnythingElse[] = _("Ti serve qualcos'altro?");
...
const u8 gText_SendOut[] = _("SCEGLI LUI");
const u8 gText_Switch2[] = _("SPOSTA");
const u8 gText_Summary5[] = _("INFO");
const u8 gText_Moves[] = _("MOSSE"); // Unused
...
const u8 gText_CantBeUsedOnPkmn[] = _("Non puoi usarlo su\nquesto POKéMON.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PPWasRestored[] = _("PP ripristinati.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MovesPPIncreased[] = _("PP di {STR_VAR_1} aumentati.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon[] = _("A quale POKéMON?");
const u8 gText_UseOnWhichPokemon[] = _("Su quale POKéMON?");
const u8 gText_GiveToWhichPokemon[] = _("A quale POKéMON?");
const u8 gText_DoWhatWithPokemon[] = _("Cosa vuoi fare con {PKMN}?");
const u8 gText_NothingToCut[] = _("Non c'è niente da tagliare,\ndeficiente.");
const u8 gText_CantSurfHere[] = _("Non si surfa qui, deficiente.");
const u8 gText_AlreadySurfing[] = _("Stai già surfando, deficiente.");
const u8 gText_CantUseHere[] = _("Qui non si può, deficiente.");
const u8 gText_RestoreWhichMove[] = _("Quale mossa?");
const u8 gText_BoostPp[] = _("Di quale mossa?");
...
const u8 gText_Learned[] = _("IMPARATA");
const u8 gText_Have[] = _("TENUTA");
const u8 gText_DontHave[] = _("NON TENUTA");
...
const u8 gText_Fraboni[] = _("FRABONI");
const u8 gText_Castellani[] = _("CASTELLANI");
const u8 gText_Petalburg[] = _("PETALBURG");
const u8 gText_Slateport[] = _("SLATEPORT");
const u8 gText_Rimini[] = _("RIMINI"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_Dipartimento[] = _("DIPARTIMENTO");
...
const u8 gText_Soldi0[] = _("¥1000");
const u8 gText_Soldi1[] = _("¥10000");
const u8 gText_Soldi2[] = _("¥100000");