...
{
    [MAPSEC_RIMINI_TOWN] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), HEAL_LOCATION_RIMINI_TOWN_BRENDANS_HOUSE_2F},
    [MAPSEC_BOLOGNA_TOWN] = {MAP_GROUP(BOLOGNA_TOWN), MAP_NUM(BOLOGNA_TOWN), HEAL_LOCATION_BOLOGNA_TOWN},
    [MAPSEC_DIPARTIMENTO_FISICA] = {MAP_GROUP(DIPARTIMENTO_FISICA), MAP_NUM(DIPARTIMENTO_FISICA), HEAL_LOCATION_DIPARTIMENTO_FISICA},
    [MAPSEC_SANTA_GIUSTINA] = {MAP_GROUP(SANTA_GIUSTINA), MAP_NUM(SANTA_GIUSTINA), HEAL_LOCATION_SANTA_GIUSTINA},
    [MAPSEC_EMILIA_ROAD] = {MAP_GROUP(EMILIA_ROAD), MAP_NUM(EMILIA_ROAD), HEAL_LOCATION_EMILIA_ROAD},
    [MAPSEC_RIMINI_MARE] = {MAP_GROUP(RIMINI_MARE), MAP_NUM(RIMINI_MARE), HEAL_LOCATION_RIMINI_MARE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_RIMINI_TOWN:
        return FlagGet(FLAG_VISITED_RIMINI_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BOLOGNA_TOWN:
        return FlagGet(FLAG_VISITED_BOLOGNA_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_DIPARTIMENTO_FISICA:
        return FlagGet(FLAG_VISITED_DIPARTIMENTO_FISICA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SANTA_GIUSTINA:
        return FlagGet(FLAG_VISITED_SANTA_GIUSTINA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_EMILIA_ROAD:
        return FlagGet(FLAG_VISITED_EMILIA_ROAD) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RIMINI_MARE:
        return FlagGet(FLAG_VISITED_RIMINI_MARE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_RIMINI_TOWN:
                    SetWarpDestinationToHealLocation(gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_RIMINI_TOWN_BRENDANS_HOUSE : HEAL_LOCATION_RIMINI_TOWN_MAYS_HOUSE);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
