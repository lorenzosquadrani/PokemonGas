...
{
    [MAPSEC_RIMINI] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_RIMINI; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
