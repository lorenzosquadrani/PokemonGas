...
bool8 UsedPokemonCenterWarp(void)
{
    static const u16 sPokemonCenters[] =
    {
        ...
        MAP_EMILIA_ROAD_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    static const u8 sPokeMarts[][3] =
    {
        ...
        { MAP_GROUP(SANTA_GIUSTINA_MART),  MAP_NUM(SANTA_GIUSTINA_MART),  LOCALID_SANTA_MART_CLERK },
        { MAP_GROUP(EMILIA_ROAD_MART),  MAP_NUM(EMILIA_ROAD_MART),  LOCALID_EMILIA_MART_CLERK },
