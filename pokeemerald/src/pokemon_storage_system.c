...
} static const sRestrictedReleaseMoves[] =
{
    ...
    {MAP_GROUP(DIFA_POKEMON_LEAGUE_1F), MAP_NUM(DIFA_POKEMON_LEAGUE_1F), MOVE_STRENGTH},
    {MAP_GROUP(DIFA_POKEMON_LEAGUE_1F), MAP_NUM(DIFA_POKEMON_LEAGUE_1F), MOVE_ROCK_SMASH},
    {MAP_GROUP(DIFA_POKEMON_LEAGUE_2F), MAP_NUM(DIFA_POKEMON_LEAGUE_2F), MOVE_STRENGTH},
    {MAP_GROUP(DIFA_POKEMON_LEAGUE_2F), MAP_NUM(DIFA_POKEMON_LEAGUE_2F), MOVE_ROCK_SMASH},
};
