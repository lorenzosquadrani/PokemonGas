...
{
    [MAPSEC_RIMINI_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BOLOGNA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DIPARTIMENTO_FISICA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SANTA_GIUSTINA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_EMILIA_ROAD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RIMINI_MARE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MARECCHIA] = MAPPOPUP_THEME_WOOD,
