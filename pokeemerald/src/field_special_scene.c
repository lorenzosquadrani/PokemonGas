...
static void Task_HandleTruckSequence(u8 taskId)
{
   s16 *data = gTasks[taskId].data;
    ...
    case 5:
        ...
        if (tTimer == 120)
        {
            MapGridSetMetatileIdAt(4 + MAP_OFFSET, 1 + MAP_OFFSET, METATILE_RiminiTown_InsideOfTruck_ExitLight_Top);
            MapGridSetMetatileIdAt(4 + MAP_OFFSET, 2 + MAP_OFFSET, METATILE_RiminiTown_InsideOfTruck_ExitLight_Mid);
            MapGridSetMetatileIdAt(4 + MAP_OFFSET, 3 + MAP_OFFSET, METATILE_RiminiTown_InsideOfTruck_ExitLight_Bottom);
            DrawWholeMapView();
...
{
    MapGridSetMetatileIdAt(4 + MAP_OFFSET, 1 + MAP_OFFSET, METATILE_RiminiTown_InsideOfTruck_DoorClosedFloor_Top);
    MapGridSetMetatileIdAt(4 + MAP_OFFSET, 2 + MAP_OFFSET, METATILE_RiminiTown_InsideOfTruck_DoorClosedFloor_Mid);
    MapGridSetMetatileIdAt(4 + MAP_OFFSET, 3 + MAP_OFFSET, METATILE_RiminiTown_InsideOfTruck_DoorClosedFloor_Bottom);
    DrawWholeMapView();
