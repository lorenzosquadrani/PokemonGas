...
static const u16 sSaveLocationPokeCenterList[] =
{
    ...
    MAP_BOLOGNA_TOWN_POKEMON_CENTER_2F,
    MAP_DIPARTIMENTO_FISICA_POKEMON_CENTER_1F,
    MAP_DIPARTIMENTO_FISICA_POKEMON_CENTER_2F,
    MAP_SANTA_GIUSTINA_POKEMON_CENTER_1F,
    MAP_SANTA_GIUSTINA_POKEMON_CENTER_2F,
    MAP_EMILIA_ROAD_POKEMON_CENTER_1F,
    MAP_EMILIA_ROAD_POKEMON_CENTER_2F,
    MAP_RIMINI_MARE_POKEMON_CENTER_1F,
    MAP_RIMINI_MARE_POKEMON_CENTER_2F,
