...
static const struct MenuAction MultichoiceList_BrineyOffDipartimento[] =
{
    {gText_Dipartimento},
    {gText_Exit},
};
...
{
    [MULTI_BRINEY_ON_DIPARTIMENTO]          = MULTICHOICE(MultichoiceList_BrineyOnDipartimento),
    ...
    [MULTI_BRINEY_OFF_DIPARTIMENTO]         = MULTICHOICE(MultichoiceList_BrineyOffDipartimento),
