...
const struct Tileset gTileset_Dipartimento =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Dipartimento,
    .palettes = gTilesetPalettes_Dipartimento,
    .metatiles = gMetatiles_Dipartimento,
    .metatileAttributes = gMetatileAttributes_Dipartimento,
    .callback = InitTilesetAnim_Dipartimento,
};
...
const struct Tileset gTileset_CasaGasSte =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CasaGasSte,
    .palettes = gTilesetPalettes_CasaGasSte,
    .metatiles = gMetatiles_CasaGasSte,
    .metatileAttributes = gMetatileAttributes_CasaGasSte,
    .callback = NULL,
};
...
const struct Tileset gTileset_DipartimentoGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_DipartimentoGym,
    .palettes = gTilesetPalettes_DipartimentoGym,
    .metatiles = gMetatiles_DipartimentoGym,
    .metatileAttributes = gMetatileAttributes_DipartimentoGym,
    .callback = NULL,
};
...
const struct Tileset gTileset_Bologna =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Bologna,
    .palettes = gTilesetPalettes_Bologna,
    .metatiles = gMetatiles_Bologna,
    .metatileAttributes = gMetatileAttributes_Bologna,
    .callback = NULL,
};
