const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_ELITE_FOUR_UGUCCIONI] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELITE_FOUR_FRABONI] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELITE_FOUR_CASTELLANI] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ELITE_FOUR_KAMENCIK] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ELITE_FOUR_UGUCCIONI, gTrainerFrontPic_EliteFouruguccioni, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_FRABONI, gTrainerFrontPic_EliteFourFraboni, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_CASTELLANI, gTrainerFrontPic_EliteFourCastellani, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_KAMENCIK, gTrainerFrontPic_EliteFourKamencik, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ELITE_FOUR_UGUCCIONI, gTrainerPalette_EliteFouruguccioni),
    TRAINER_PAL(ELITE_FOUR_FRABONI, gTrainerPalette_EliteFourFraboni),
    TRAINER_PAL(ELITE_FOUR_CASTELLANI, gTrainerPalette_EliteFourCastellani),
    TRAINER_PAL(ELITE_FOUR_KAMENCIK, gTrainerPalette_EliteFourKamencik),
