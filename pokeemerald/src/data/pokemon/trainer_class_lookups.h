const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_ELITE_FOUR_UGUCCIONI] = TRAINER_PIC_ELITE_FOUR_UGUCCIONI,
    [FACILITY_CLASS_ELITE_FOUR_FRABONI] = TRAINER_PIC_ELITE_FOUR_FRABONI,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_GENTLEMAN] = TRAINER_CLASS_PROFESSOR,
    [FACILITY_CLASS_ELITE_FOUR_UGUCCIONI] = TRAINER_CLASS_ELITE_FOUR,
    [FACILITY_CLASS_ELITE_FOUR_FRABONI] = TRAINER_CLASS_ELITE_FOUR,
