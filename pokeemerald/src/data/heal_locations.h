...
{
    [HEAL_LOCATION_RIMINI_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(RIMINI_TOWN_BRENDANS_HOUSE_2F), MAP_NUM(RIMINI_TOWN_BRENDANS_HOUSE_2F), 4, 2},
    [HEAL_LOCATION_RIMINI_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(RIMINI_TOWN_MAYS_HOUSE_2F), MAP_NUM(RIMINI_TOWN_MAYS_HOUSE_2F), 4, 2},
    ...
    [HEAL_LOCATION_RIMINI_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 11, 21},
    [HEAL_LOCATION_RIMINI_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 21, 21},
    [HEAL_LOCATION_BOLOGNA_TOWN - 1] = {MAP_GROUP(BOLOGNA_TOWN), MAP_NUM(BOLOGNA_TOWN), 6, 17},
    [HEAL_LOCATION_DIPARTIMENTO_FISICA - 1] = {MAP_GROUP(DIPARTIMENTO_FISICA), MAP_NUM(DIPARTIMENTO_FISICA), 2, 11},
    [HEAL_LOCATION_SANTA_GIUSTINA - 1] = {MAP_GROUP(SANTA_GIUSTINA), MAP_NUM(SANTA_GIUSTINA), 9, 7},
    [HEAL_LOCATION_EMILIA_ROAD - 1] = {MAP_GROUP(EMILIA_ROAD), MAP_NUM(EMILIA_ROAD), 14, 8},
