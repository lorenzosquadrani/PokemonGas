static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RIMINI_TOWN_CASA_GAS - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 11, 21},
    [HEAL_LOCATION_RIMINI_TOWN_CASA_STE - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 21, 21},
    ...
    [HEAL_LOCATION_SANTA_GIUSTINA - 1] = {MAP_GROUP(SANTA_GIUSTINA), MAP_NUM(SANTA_GIUSTINA), 23, 15},
