static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RIMINI_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 27, 28},
    [HEAL_LOCATION_RIMINI_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 14, 9},
