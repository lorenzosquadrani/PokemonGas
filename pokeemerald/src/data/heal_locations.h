static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RIMINI_TOWN_CASA_GAS - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 11, 24},
    [HEAL_LOCATION_RIMINI_TOWN_CASA_STE - 1] = {MAP_GROUP(RIMINI_TOWN), MAP_NUM(RIMINI_TOWN), 21, 24},
