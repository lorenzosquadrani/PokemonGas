...
extern const u8 gText_Fraboni[];
extern const u8 gText_Castellani[];
...
extern const u8 MatchCall_Text_Fraboni[];
extern const u8 MatchCall_Text_Castellani[];
extern const u8 MatchCall_Text_Kamencik[];
